                    ...
                    <div style={{ 
                      ...
                      {imgFiles1.length > 0 && (
                        ...
                        >
                          ...
                          <div style={{ textAlign: 'left' }}>
                            <div>Enviar texto + imagens ({imgFiles1.length})</div>
                          </div>
                        </button>
                      )}
                      ...
                      {pdfFiles1.length > 0 && (
                        ...
                        >
                          ...
                          <div style={{ textAlign: 'left' }}>
                            <div>Enviar texto + PDFs ({pdfFiles1.length})</div>
                    ...
                    <div style={{ 
                      ...
                      {imgFiles2.length > 0 && (
                        ...
                        >
                          <Paperclip size={20} style={{ flexShrink: 0 }} />
                          <div style={{ textAlign: 'left' }}>
                            <div>Enviar texto + imagens ({imgFiles2.length})</div>
                          </div>
                        </button>
                      )}
