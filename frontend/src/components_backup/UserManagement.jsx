...
export default function UserManagement({ currentUser }) {
  ...
  const MAP_FIELDS = [
    ...
    { id: 'pos', label: 'PÓS' },
    { id: 'attachment_url', label: 'Anexo (Upload)' },
